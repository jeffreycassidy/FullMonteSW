...
// ADDED THESE AS A GUESS
#define DSFMT_MSK1 UINT64_C(0x007ffaff007ffb3f)
#define DSFMT_MSK2 UINT64_C(0x007ffdff0079fffd)

#define DSFMT_MSK32_1 0x007ffaff
#define DSFMT_MSK32_2 0x007ffb3f
#define DSFMT_MSK32_3 0x007ffdff
#define DSFMT_MSK32_4 0x0079fffd
...
//				    DSFMT_MSK32_1, DSFMT_MSK32_2);
    ...
    // IEEE754 single is 1 sign, 8 exp, 23 mantissa (+1 implicit leading 1)
//    sse2_param_mask = _mm_set_epi32(0x007fffff,0x007fffff,0x007fffff,0x007fffff); // first attempt
...
inline static void do_recursion(w128_t *r, w128_t *a, w128_t *b, w128_t *u) {
    ...
    // right-shift is now 9 elements (1 sign + 8 exp)
    v = _mm_srli_epi32(y, 9);
    w = _mm_and_si128(y, sse2_param_mask);  // mask has been changed
    v = _mm_xor_si128(v, x);
    v = _mm_xor_si128(v, w);
    r->si = v;
    u->si = y;
