...
montecarlo-static: graph.o newgeom.o face.o helpers.o source.o montecarlo.o LoggerSurface.o io_timos.o progress.o utils/writeFileVTK.o linefile.o fluencemap.o mainloop.o fm-postgres/fm-postgres.o blob.o fmdb.o fm-postgres/fmdbexportcase.o sse.o random.o SFMT.o LoggerConservation.o LoggerEvent.o LoggerVolume.o /usr/lib/libpq.a /usr/local/lib/boost/libboost_program_options.a /usr/local/lib/boost/libboost_system.a
	g++ $(GCC_OPTS) $^ -static -lrt -lpthread -lssl -lcrypto $(LIBDIRS) -o $@
