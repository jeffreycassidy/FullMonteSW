% Plots a DVH with 2*sigma bars on the horizontal axis
%
% frontiers_dvh_plot(regions,phi_v,V,region)
%
...
function [phi_dvh,v_dvh,sigma_dvh] = frontiers_dvh_plot(regions,phi_v,V,region)
...
plot([phi_dvh-2*sigma_dvh phi_dvh+2*sigma_dvh]',repmat(([1;v_dvh(1:end-1)]+v_dvh)/2,[1 2])','r-');
